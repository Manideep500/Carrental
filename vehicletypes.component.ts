...
formvalid() {
    return (this.selectlocation && this.pickupdate &&this.returndate );
  }

cars: any[] = [
    { name: 'SUV', category:'premier', Model: 2023, Luggage: '2 bags', milage: 30, photo: '/assets/Suv1.jpeg' },
    { name: 'Seaden',category:'economy', Model: 2022, Luggage: '6 bags', milage: 20, photo: '/assets/sedan.jpg' },
    ...
    { name: 'Tempo', category:'luxuary',Model: 2016, Luggage: '6 bags', milage: 40, photo: '/assets/Tempo1.jpg' }
  ];
  

categories:string[]=['economy','premier','luxuary'];
